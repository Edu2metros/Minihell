...
/*is_operator(char *input): Checks if a string contains shell operators like '>>', '<<', '>', '<', '|'. It returns different constants depending on the operator.*/
...
/*is_word(const char *input): Checks if a string is a word (sequence of alphabetic characters). It returns a constant WORD if it is, and 1 otherwise.*/
...
/*is_arg(const char *input): Checks if a string is an argument (starts with '-' followed by alphabetic characters). It returns a constant ARG if it is, and 1 otherwise.*/
...
/*is_builtin(char *input): Checks if a string is a shell built-in command like 'echo', 'cd', 'pwd', 'export', 'unset', 'env', 'exit'. It returns different constants depending on the command.*/
...
/*tokenizer(char *input, t_token *token): This function tokenizes the input string. It uses the above functions to identify different types of tokens (quotes, operators, words, arguments, built-in commands) and adds them to a token list.*/
...
//         {
//             i++;
//             while (input[i] != '\0' && is_quote(input[i]) == 0)
//                 i++;
...
//         else if (is_word(input + i) != 1)
//         {
//             while (input[i] != '\0' && is_word(input + i) == 1 && input[i] != ' ')
//                 i++;
//             substr = ft_substr(input, start, i - start);
//             add_token(substr, is_word(substr), mini);
//         }
//         else if (is_arg(input + i) != 1)
//         {
//             while (input[i] != '\0' && is_arg(input + i) == 1 && input[i] != ' ')
//                 i++;
//             substr = ft_substr(input, start, i - start);
//             add_token(substr, is_arg(substr), mini);
//         }
//         else if (is_builtin(input + i) != 1)
//         {
//             while (input[i] != '\0' && is_builtin(input + i) == 1 && input[i] != ' ')
//                 i++;
//             substr = ft_substr(input, start, i - start);
//             add_token(substr, is_builtin(substr), mini);
//         }
